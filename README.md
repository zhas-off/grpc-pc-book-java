...
- *Defining gRPC services with protocol-buffer and generate Java codes.*
...
## P.S.
PC Book can communicate and exchange data on the local network with application that is written on another language like [gRPC PC Book - Go](https://github.com/zhas-off/grpc-pc-book)
